<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="WebPatient.Profile" %>
            ...
            <div>
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <asp:TextBox ID="txtDni" CssClass="form-control" textMode="SingleLine" runat="server" Enabled="false"></asp:TextBox>
                </div>

                <div class="col-sm-6">
                    <label for="txtPassword" class="form-label">Contraseña</label>
                    <div class="input-group">
                        <asp:TextBox ID="txtPassword" CssClass="form-control" textMode="SingleLine" type="password" runat="server" Enabled="false"></asp:TextBox>
                ...
                <div class="col-sm-6">
                    ...
                    <asp:TextBox ID="txtFirstName" CssClass="form-control" textMode="SingleLine" runat="server" Enabled="false"></asp:TextBox>
                </div>

                <div class="col-sm-6">
                    <label for="txtLastName" class="form-label">Apellidos</label>
                    <asp:TextBox ID="txtLastName" CssClass="form-control" textMode="SingleLine" runat="server" Enabled="false"></asp:TextBox>
                </div>

                <div class="col-sm-4">
                    <label for="txtBirthday" class="form-label">Fecha de nacimiento</label>
                    <asp:TextBox ID="txtBirthday" CssClass="form-control" textMode="SingleLine" runat="server" Enabled="false"></asp:TextBox>
                </div>

                <div class="col-sm-4">
                    <label for="txtPhone" class="form-label">Celular</label>
                    <asp:TextBox ID="txtPhone" CssClass="form-control" textMode="SingleLine" runat="server" Enabled="false"></asp:TextBox>
                </div>
