<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ScheduleAppointment.aspx.cs" Inherits="WebPatient.ScheduleAppointment" %>
            ...
            <div>
              <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <asp:DropDownList ID="ddlArea" CssClass="form-select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlArea_SelectedIndexChanged"></asp:DropDownList>
                </div>
