...
namespace WebPatient.ProxyArea {
    ...
    public interface IServiceArea {
        ...
        bool CreateArea(WebPatient.ProxyArea.AreaBE objAreaBE);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceArea/CreateArea", ReplyAction="http://tempuri.org/IServiceArea/CreateAreaResponse")]
        System.Threading.Tasks.Task<bool> CreateAreaAsync(WebPatient.ProxyArea.AreaBE objAreaBE);
        ...
        WebPatient.ProxyArea.AreaBE[] GetAllAreas();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceArea/GetAllAreas", ReplyAction="http://tempuri.org/IServiceArea/GetAllAreasResponse")]
        System.Threading.Tasks.Task<WebPatient.ProxyArea.AreaBE[]> GetAllAreasAsync();
        ...
        WebPatient.ProxyArea.AreaBE GetOneArea(short id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceArea/GetOneArea", ReplyAction="http://tempuri.org/IServiceArea/GetOneAreaResponse")]
        System.Threading.Tasks.Task<WebPatient.ProxyArea.AreaBE> GetOneAreaAsync(short id);
        ...
        bool UpdateArea(WebPatient.ProxyArea.AreaBE objAreaBE);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceArea/UpdateArea", ReplyAction="http://tempuri.org/IServiceArea/UpdateAreaResponse")]
        System.Threading.Tasks.Task<bool> UpdateAreaAsync(WebPatient.ProxyArea.AreaBE objAreaBE);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceAreaChannel : WebPatient.ProxyArea.IServiceArea, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceAreaClient : System.ServiceModel.ClientBase<WebPatient.ProxyArea.IServiceArea>, WebPatient.ProxyArea.IServiceArea {
        ...
        public bool CreateArea(WebPatient.ProxyArea.AreaBE objAreaBE) {
            return base.Channel.CreateArea(objAreaBE);
        }
        
        public System.Threading.Tasks.Task<bool> CreateAreaAsync(WebPatient.ProxyArea.AreaBE objAreaBE) {
            return base.Channel.CreateAreaAsync(objAreaBE);
        }
        
        public WebPatient.ProxyArea.AreaBE[] GetAllAreas() {
            return base.Channel.GetAllAreas();
        }
        
        public System.Threading.Tasks.Task<WebPatient.ProxyArea.AreaBE[]> GetAllAreasAsync() {
            return base.Channel.GetAllAreasAsync();
        }
        
        public WebPatient.ProxyArea.AreaBE GetOneArea(short id) {
            return base.Channel.GetOneArea(id);
        }
        
        public System.Threading.Tasks.Task<WebPatient.ProxyArea.AreaBE> GetOneAreaAsync(short id) {
            return base.Channel.GetOneAreaAsync(id);
        }
        
        public bool UpdateArea(WebPatient.ProxyArea.AreaBE objAreaBE) {
            return base.Channel.UpdateArea(objAreaBE);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateAreaAsync(WebPatient.ProxyArea.AreaBE objAreaBE) {
