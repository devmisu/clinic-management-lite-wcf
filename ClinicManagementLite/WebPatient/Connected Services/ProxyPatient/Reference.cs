...
namespace WebPatient.ProxyPatient {
    ...
    public interface IServicePatient {
        ...
        bool CreatePatient(WebPatient.ProxyPatient.PatientBE objPatientBE);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/CreatePatient", ReplyAction="http://tempuri.org/IServicePatient/CreatePatientResponse")]
        System.Threading.Tasks.Task<bool> CreatePatientAsync(WebPatient.ProxyPatient.PatientBE objPatientBE);
        ...
        WebPatient.ProxyPatient.PatientBE[] GetAllPatients();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetAllPatients", ReplyAction="http://tempuri.org/IServicePatient/GetAllPatientsResponse")]
        System.Threading.Tasks.Task<WebPatient.ProxyPatient.PatientBE[]> GetAllPatientsAsync();
        ...
        WebPatient.ProxyPatient.PatientBE GetPatient(short id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<WebPatient.ProxyPatient.PatientBE> GetPatientAsync(short id);
        ...
        bool UpdatePatient(WebPatient.ProxyPatient.PatientBE objPatientBE);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/UpdatePatient", ReplyAction="http://tempuri.org/IServicePatient/UpdatePatientResponse")]
        System.Threading.Tasks.Task<bool> UpdatePatientAsync(WebPatient.ProxyPatient.PatientBE objPatientBE);
        ...
        WebPatient.ProxyPatient.PatientBE Login(string dni, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/Login", ReplyAction="http://tempuri.org/IServicePatient/LoginResponse")]
        System.Threading.Tasks.Task<WebPatient.ProxyPatient.PatientBE> LoginAsync(string dni, string password);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : WebPatient.ProxyPatient.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<WebPatient.ProxyPatient.IServicePatient>, WebPatient.ProxyPatient.IServicePatient {
        ...
        public bool CreatePatient(WebPatient.ProxyPatient.PatientBE objPatientBE) {
            return base.Channel.CreatePatient(objPatientBE);
        }
        
        public System.Threading.Tasks.Task<bool> CreatePatientAsync(WebPatient.ProxyPatient.PatientBE objPatientBE) {
            return base.Channel.CreatePatientAsync(objPatientBE);
        }
        
        public WebPatient.ProxyPatient.PatientBE[] GetAllPatients() {
            return base.Channel.GetAllPatients();
        }
        
        public System.Threading.Tasks.Task<WebPatient.ProxyPatient.PatientBE[]> GetAllPatientsAsync() {
            return base.Channel.GetAllPatientsAsync();
        }
        
        public WebPatient.ProxyPatient.PatientBE GetPatient(short id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<WebPatient.ProxyPatient.PatientBE> GetPatientAsync(short id) {
            return base.Channel.GetPatientAsync(id);
        }
        
        public bool UpdatePatient(WebPatient.ProxyPatient.PatientBE objPatientBE) {
            return base.Channel.UpdatePatient(objPatientBE);
        }
        
        public System.Threading.Tasks.Task<bool> UpdatePatientAsync(WebPatient.ProxyPatient.PatientBE objPatientBE) {
        ...
        public WebPatient.ProxyPatient.PatientBE Login(string dni, string password) {
            return base.Channel.Login(dni, password);
        }
        
        public System.Threading.Tasks.Task<WebPatient.ProxyPatient.PatientBE> LoginAsync(string dni, string password) {
