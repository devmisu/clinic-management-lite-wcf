        ...
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h2 class="card-title pricing-card-title"><small class="text-muted fw-light">Podrá visualizar a sus pacientes ya atendidos con anterioridad.</small></h2>
              <br />
            <button type="button" class="w-100 btn btn-lg btn-outline-primary">Visualizar</button>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h2 class="card-title pricing-card-title"><small class="text-muted fw-light">Podrá visualizar las citas pasadas.</small></h2>
              <br />
            <asp:Button ID="btnAppointments" runat="server" OnClick="btnAppointments_Click" type="button" class="w-100 btn btn-lg btn-outline-primary" Text="Visualizar"></asp:Button>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h2 class="card-title pricing-card-title"><small class="text-muted fw-light">Podrá administrar sus horarios de atención.</small></h2>
              <br />
            <button type="button" class="w-100 btn btn-lg btn-primary">Administrar</button>
          </div>
        </div>
      </div>
    </div>
