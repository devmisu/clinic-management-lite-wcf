<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeBehind="CreateArea.aspx.cs" Inherits="WebClinicManagementLiteAdmin.CreateArea" %>
                ...
                <div class="col">
                    ...
                    <div>
                        ...
                        <div class="row g-3">
                            ...
                            <asp:Button ID="btnCreateArea" CssClass="w-100 btn btn-primary btn-lg" runat="server" Text="Crear" OnClick="btnCreateArea_Click"/>
                        </div>
                    </div>
                </div>
            </div>
