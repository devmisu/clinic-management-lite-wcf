<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeBehind="ShowQueues.aspx.cs" Inherits="WebClinicManagementLiteAdmin.ShowQueues" %>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body table-responsive">
                        <asp:GridView ID="gdvQueues" Width="100%" CssClass="table table-striped table-bordered table-hover" runat="server" OnSelectedIndexChanged="gdvQueues_SelectedIndexChanged">
                        </asp:GridView>
                    </div>
                </div>
            </div>
