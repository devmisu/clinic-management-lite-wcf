<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="WebClinicManagementLiteAdmin.UpdateUser" %>
        ...
        <div class="row g-5">
          <div class="col">
            ...
            <asp:Panel ID="viewSuccess" class="alert alert-success alert-dismissible mb-3" role="alert" runat="server" Visible="false">
                ...
                <a href="ShowUsers.aspx" class="alert-link">Volver al listado de usuarios</a>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </asp:Panel>
            ...
            <div>
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                    <label for="ddlRole" class="form-label">Rol</label>
                    <asp:DropDownList ID="ddlRole" CssClass="form-select" runat="server" AutoPostBack="true"></asp:DropDownList>
                </div>
                ...
                <div class="col-sm-6">
                    <label for="txtSpecialization" class="form-label">Especializacion</label>
